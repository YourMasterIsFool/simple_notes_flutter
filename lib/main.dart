...
import 'package:flutter_task_sqlite/custom_router.dart';
...
class MyApp extends HookWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      theme: ThemeData(
          colorScheme:
              ThemeData().colorScheme.copyWith(primary: Colors.grey.shade200),
          appBarTheme: AppBarTheme(
              actionsIconTheme:
                  IconThemeData(color: Colors.grey.shade400, size: 24),
              iconTheme: IconThemeData(color: Colors.grey.shade200),
              titleTextStyle:
                  textTitle.copyWith(fontSize: 18, fontWeight: FontWeight.bold),
              centerTitle: true,
